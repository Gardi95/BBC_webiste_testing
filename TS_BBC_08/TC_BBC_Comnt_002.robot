...
${view_comments}  //*[@id="view-comments"]/div/div/div[2]/div/span/div/div[3]/div[2]/span/div/div
...
TC_BBC_Comnt_002
    ...
    Page Should Contain Button  ${button1}
    Click Element  ${button1}
    Click Element  ${Link}
    Click Element  ${button2}
    Page Should Contain Button  ${button2}
    Click Element  ${view_comments}
